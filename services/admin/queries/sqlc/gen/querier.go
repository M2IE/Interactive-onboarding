...
type Querier interface {
	...
	GetFlowScenarioMembership(ctx context.Context, db DBTX, scenarioID uuid.UUID) (FlowScenario, error)
	...
	GetScenarioByProjectURLAndStatus(ctx context.Context, db DBTX, arg GetScenarioByProjectURLAndStatusParams) (Scenario, error)
